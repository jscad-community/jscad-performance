...
const hull_sphere_1000 = {
  ...
  api  : 'hull(sphere)',
  div  : '1000',
  func : function runme() { return sphere_1000[0].hull(sphere_1000.slice(1)) }
}
...
const hull_sphere_10000 = {
  ...
  api  : 'hull(sphere)',
  div  : '10000',
  func : function runme() { return sphere_10000[0].hull(sphere_10000.slice(1)) }
}
...
const hull_sphere_100000 = {
  ...
  api  : 'hull(sphere)',
  div  : '100000',
  func : function runme() { return sphere_100000[0].hull(sphere_100000.slice(1)) }
}
