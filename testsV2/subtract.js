...
const subtract = require('./csg.js/src/operations/booleans/subtract')
...
const subtract_sphere_100000 = {
  name : 'subtract(100000)',
  api  : 'subtract(sphere)',
  div  : '100000',
  func : function runme() { return subtract(sphere_100000) }
}

const subtract_sphere_500000 = {
  name : 'subtract(50000)',
  api  : 'subtract(sphere)',
  div  : '50000',
...
//  subtract_sphere_100000,
//  subtract_sphere_500000
//  subtract_sphere_1000000
}
