...
const {center, mirror, rotate, scale, translate} = require('./csg.js/src/operations/transforms')
...
const transform_arc_10 = {
  ...
  api  : 'transform(arc)',
  div  : '10',
  func : function run() { return path2.toPoints(translate(newoffsets, rotate(newangles, scale(newfactors, arc_16)))) }
}
...
const transform_arc_100 = {
  ...
  api  : 'transform(arc)',
  div  : '100',
  func : function run() { return path2.toPoints(translate(newoffsets, rotate(newangles, scale(newfactors, arc_196)))) }
}
...
const transform_arc_200 = {
  ...
  api  : 'transform(arc)',
  div  : '200',
  func : function run() { return path2.toPoints(translate(newoffsets, rotate(newangles, scale(newfactors, arc_396)))) }
}
...
const transform_arc_400 = {
  ...
  api  : 'transform(arc)',
  div  : '400',
  func : function run() { return path2.toPoints(translate(newoffsets, rotate(newangles, scale(newfactors, arc_796)))) }
}
...
const transform_circle_10 = {
  ...
  div  : '10',
  func : function run() { return geom2.toSides(translate(newoffsets, rotate(newangles, scale(newfactors, circle_10)))) }
}
...
const transform_circle_100 = {
  ...
  api  : 'transform(circle)',
  div  : '100',
  func : function run() { return geom2.toSides(translate(newoffsets, rotate(newangles, scale(newfactors, circle_100)))) }
}
...
const transform_circle_1000 = {
  ...
  api  : 'transform(circle)',
  div  : '1000',
  func : function run() { return geom2.toSides(translate(newoffsets, rotate(newangles, scale(newfactors, circle_1000)))) }
}
...
const transform_sphere_100 = {
  ...
  div  : '100',
  func : function run() { return geom3.toPolygons(translate(newoffsets, rotate(newangles, scale(newfactors, sphere_7)))) }
}
...
const transform_sphere_1000 = {
  ...
  api  : 'transform(sphere)',
  div  : '1000',
  func : function run() { return geom3.toPolygons(translate(newoffsets, rotate(newangles, scale(newfactors, sphere_22)))) }
}
...
const transform_sphere_10000 = {
  ...
  api  : 'transform(sphere)',
  div  : '10000',
  func : function run() { return geom3.toPolygons(translate(newoffsets, rotate(newangles, scale(newfactors, sphere_70)))) }
}
...
const transform_sphere_50000 = {
  ...
  api  : 'transform(sphere)',
  div  : '50000',
  func : function run() { return geom3.toPolygons(translate(newoffsets, rotate(newangles, scale(newfactors, sphere_158)))) }
}
...
const transform_sphere_100000 = {
  ...
  api  : 'transform(sphere)',
  div  : '100000',
  func : function run() { return geom3.toPolygons(translate(newoffsets, rotate(newangles, scale(newfactors, sphere_224)))) }
}
