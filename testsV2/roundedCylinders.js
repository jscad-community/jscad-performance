const {roundedCylinder} = require('./csg.js/src/primitives');
...
const roundedCylinder_720 = {
  name : 'roundedCylinder(segments: 720)',
  api  : 'roundedCylinder',
  div  : '720',
  func : function runme() { return roundedCylinder({radius: 100, roundradius: 10, segments: 720}) }
}
